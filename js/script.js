...
logoElement.style.animation = 'logo 1.3s ease-in-out forwards';

logoElement.addEventListener('animationend', () => {
  textElement.style.animation = 'text 3s ease forwards';

    textElement.addEventListener('animationend', () => {
        link1Element.style.opacity = 1;
        link1Element.style.animation = 'link 1.5s ease forwards';

        link1Element.addEventListener('animationend', () => {
            link2Element.style.opacity = 1;
            link2Element.style.animation = 'link 1.5s ease forwards';

            link2Element.addEventListener('animationend', () => {
                link3Element.style.opacity = 1;
                link3Element.style.animation = 'link 1.5s ease forwards';
